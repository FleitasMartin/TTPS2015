...
<!-- <h3>
	<span class="label label-default"> Sugerencia </span>
</h3>-->
...
<div class="form">
	<form method="post"
		...
		<div class="col-md-12">
			...
			<div class="col-md-2">
				<button type="submit" class="form-control btn btn-success " style="margin-top: 10%;">
			...
			<div class="form-group col-md-8">
				<div>
					<h3 class="text-center col-md-4 control-label">
						<label><span class="label label-default">&iquest;Acerca de
								qu&eacute;&#63; </span> </label>
					</h3>
		...
		<div class="form-group col-md-10">
			<h3 class="text-center col-md-3 control-label">
				<label><span class="label label-default">Sugerencia </span></label>
			</h3>
